...
import { Mail, Lock, User, Building2, MapPin, Globe, ArrowRight, CheckCircle2, Briefcase } from "lucide-react";
...
export default function RecruiterRegisterPage() {
    ...
    const onSubmit = async (data: Step2Data) => {
        setIsLoading(true);
        // Combine data if needed: const finalData = { ...form1.getValues(), ...data };
