...
function ActiveShape(props: any) {
    ...
    return (
        <g>
            <text x={cx} y={cy - 10} textAnchor="middle" fill="#111827" className="text-base font-bold" fontSize={20} fontWeight={700}>{value}</text>
            <text x={cx} y={cy + 14} textAnchor="middle" fill="#6B7280" fontSize={11}>{name}</text>
            <text x={cx} y={cy + 30} textAnchor="middle" fill="#2563EB" fontSize={13} fontWeight={700}>{(percent * 100).toFixed(0)}%</text>
