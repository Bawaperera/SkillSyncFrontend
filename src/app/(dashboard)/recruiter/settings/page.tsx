            ...
            <Card title="Personal Information">
                <div className="grid sm:grid-cols-2 gap-4">
                    {[
                        ...
                        { label: "Last Name", value: "Jenkins", placeholder: "Last name" },
                        { label: "Job Title", value: "HR Manager", placeholder: "Your role" },
                        { label: "Phone", value: "+94 71 234 5678", placeholder: "+94..." },
                    ].map((f) => (
                        <div key={f.label}>
