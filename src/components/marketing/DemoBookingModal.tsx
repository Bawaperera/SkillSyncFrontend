...
import { X, Calendar, Clock, Globe, ChevronLeft, ChevronRight, CheckCircle2 } from "lucide-react";
                ...
                <>
                    ...
                    <div className="fixed inset-0 z-[101] flex items-center justify-center p-4">
                        <motion.div
                            ...
                            className="bg-white rounded shadow-2xl overflow-hidden w-full max-w-4xl flex flex-col md:flex-row max-h-[90vh]"
                        >
                            {/* Left Panel: Info */}
                            ...
                            <div className="md:w-2/3 p-6 bg-white overflow-hidden flex flex-col">
                                <div className="flex justify-between items-center mb-4">
                                    ...
                                    <button onClick={closeDemoModal} className="p-2 hover:bg-gray-100 rounded transition-colors">
                                    ...
                                    <div className="grid grid-cols-3 sm:grid-cols-4 gap-3">
                                        {timeSlots.map((time) => (
                                            <button
                                                ...
                                                className={cn(
                                                    "py-2 px-3 rounded text-sm font-medium border transition-all",
                                                    selectedTime === time
                                ...
                                <div className="flex flex-col sm:flex-row items-center justify-between pt-4 border-t border-gray-100 gap-4 mt-auto">
                                    <div className="flex items-center gap-2 text-sm text-gray-600 bg-gray-50 px-3 py-2 rounded cursor-pointer hover:bg-gray-100 transition-colors w-full sm:w-auto">
                                    ...
                                    <button
                                        ...
                                        className={cn(
                                            "px-8 py-3 rounded font-bold transition-all w-full sm:w-auto",
