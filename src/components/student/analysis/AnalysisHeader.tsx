    ...
    return (
        <GlassCard className="p-6 relative overflow-hidden group bg-white border-blue-100 shadow-sm">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 relative z-10">
                ...
                <button className="px-4 py-2 rounded bg-white hover:bg-gray-50 border border-gray-200 text-sm font-medium text-gray-600 hover:text-gray-900 transition-colors shadow-sm">
                    Change Goal
                </button>
            </div>
        </GlassCard>
