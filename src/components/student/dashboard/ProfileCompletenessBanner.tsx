...
export function ProfileCompletenessBanner() {
    ...
    const steps = [
        ...
        },
        {
            ...
            completed: user.onboarding.linkedinConnected,
            href: "/student/profile",
        },
        {
            id: "role",
            ...
            icon: <Target size={20} />,
            completed: user.onboarding.targetRoleSelected,
            href: "/student/profile",
        },
    ];
    ...
    return (
        <GlassCard className="p-8 mb-8 border border-blue-100 bg-white/80 backdrop-blur-sm shadow-sm relative overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                ...
                <div
                    className={`px-4 py-1.5 rounded-full font-bold text-sm border shadow-sm ${
                        progressPercent >= 80
